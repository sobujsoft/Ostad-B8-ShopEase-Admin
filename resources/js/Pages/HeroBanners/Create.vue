<template>
    <AppLayout>
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-slate-800">Create Hero Banner</h1>
            <p class="text-slate-500 text-sm mt-1">Add a new homepage hero banner</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 max-w-2xl">
            <form @submit.prevent="handleSubmit" class="space-y-5">
                ...
                <!-- Banner Image -->
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1.5">Banner Image <span class="text-red-500">*</span></label>
                    <div
                        class="border-2 border-dashed rounded-xl p-6 text-center transition-colors"
                        :class="errors.banner_img ? 'border-red-300 bg-red-50' : 'border-slate-200 hover:border-blue-400'"
                    >
                        <div v-if="imagePreview" class="mb-4">
                            <img :src="imagePreview" class="w-48 h-28 rounded-lg object-cover mx-auto border border-slate-200" />
                        </div>
                        ...
                        <p class="text-xs text-slate-400 mt-2">JPEG, PNG, GIF, or WebP. Max 2MB.</p>
                    </div>
...
const { errors, processing, storeBanner } = useHeroBanner();
