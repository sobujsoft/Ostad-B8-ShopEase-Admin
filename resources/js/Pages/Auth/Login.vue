        ...
        <div>
            ...
            <form @submit.prevent="handleLogin" class="space-y-5">
                ...
                <button
                    type="submit"
                    :disabled="processing"
                    class="w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-500 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold rounded-xl text-sm transition-colors flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20"
                >
            ...
            <p class="mt-6 text-center text-sm text-slate-400">
                ...
                <Link href="/register" class="text-blue-400 hover:text-blue-300 font-medium transition-colors">
                    Create account
                </Link>
            </p>
        </div>
...
const { login, errors, processing } = useAuth();
