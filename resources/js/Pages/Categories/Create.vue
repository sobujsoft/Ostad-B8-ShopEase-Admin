<template>
    <AppLayout>
        ...
        <div class="mb-6">
            ...
            <p class="text-slate-500 text-sm mt-1">Add a new product category</p>
        </div>
                ...
                <div>
                    ...
                    >
                        <div v-if="imagePreview" class="mb-4">
                            <img :src="imagePreview" class="w-24 h-24 rounded-lg object-cover mx-auto border border-slate-200" />
                        </div>
...
const { errors, processing, storeCategory } = useCategory();
